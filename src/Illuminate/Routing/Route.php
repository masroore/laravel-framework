...
class Route
{
    ...
    {
        return array_if($this->action, 'prefix');
    }
    ...
    {
        return array_if($this->action, 'as');
    }
    ...
    {
        return array_if($this->action, 'controller', 'Closure');
    }
    ...
    public function middleware($middleware = null)
    {
        if (is_null($middleware)) {
            return (array)array_if($this->action, 'middleware', []);
        }
        ...
        $this->action['middleware'] = array_merge(
            (array)array_if($this->action, 'middleware', []), $middleware
        );
