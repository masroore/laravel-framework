...
class ArgonHasher implements HasherContract
{
    ...
    {
        $this->time = array_if($options, 'time', $this->time);
        $this->memory = array_if($options, 'memory', $this->memory);
        $this->threads = array_if($options, 'threads', $this->threads);
    }
    ...
    {
        return array_if($options, 'memory', $this->memory);
    }
    ...
    {
        return array_if($options, 'time', $this->time);
    }
    ...
    {
        return array_if($options, 'threads', $this->threads);
    }
